...
export const TOP_URL_WH = 'http://news.topurl.cn/api?ip=117.152.202.3';
export const IAN_URL = 'https://api.vvhan.com/api/ian?type=json';

export const HELLO_WORLD = 'Hello 可爱聪明的小机器人上线啦 :>_<:'; //招呼语
export const MY_NAME = '@帅帅微语'; // 自己的昵称
export const CONTACT_NAME = '小许'; // 想要发送消息的人（真实昵称）
export const ROOM_TOPIC = '武汉5班-2018级-华中大MBA'; // 想要发送消息的群组
...
// 详情见node_schedule文档
// 每天的8点0分0秒
export const SCHEDULE_CONFIG = '0 0 7 * * *';
